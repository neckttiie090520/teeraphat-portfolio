...
export const content = {
  ...
  approach: {
    ...
    skills: [
      {
        title: 'AI-native & agent engineering',
        summary: 'I use agents across discovery, architecture, implementation, debugging, documentation, and evaluation, while owning the decisions and review points.',
        items: ['AIDLC', 'Agent workflows', 'Context engineering', 'MCP & agent skills', 'Human approval', 'Agent evaluation'],
        proof: 'Nexora · nzs-skills',
        proofHref: '#project-nexora',
      },
      {
        title: 'Product, business & strategy',
        summary: 'I turn a business problem into a defined product: discover the workflow, challenge assumptions, design the user path, choose scope, and align technical work to an outcome.',
        items: ['Problem discovery', 'Business process analysis', 'Product vision & strategy', 'Design thinking', 'UX & user flows', 'Requirements'],
        proof: 'YouNum · DMC Connect',
        proofHref: '#project-younum',
      },
      {
        title: 'Data, documents & evaluation',
        summary: 'I collect and structure messy sources, build extraction workflows, and check AI output against evidence rather than relying on a polished demo.',
        items: ['Document intelligence', 'RPC & web data collection', 'Structured extraction', 'Dataset design', 'Ground truth', 'Error analysis'],
        proof: 'Google Maps research · hotel contracts',
        proofHref: '#project-khaosoi-research',
      },
      {
        title: 'Software & automation',
        summary: 'I build the interfaces, APIs, data models, integrations, and automation that make a workflow usable beyond a prototype.',
        items: ['System architecture', 'Full-stack development', 'API & database design', 'Business automation', 'Integrations', 'CI/CD'],
        proof: 'YouNum · InAndOn',
        proofHref: '#project-inand-on',
      },
      {
        title: 'Windows, hardware & IT',
        summary: 'My systems work reaches below the web stack: Windows behavior, PC performance, device tooling, diagnostics, and practical support for people using the system.',
        items: ['Windows OS diagnostics', 'PC optimization', 'Latency research', 'HID devices', 'IT support', 'Workspace administration'],
        proof: 'ClutchG · ATK firmware',
        proofHref: '#project-clutchg-pc-optimizer',
      },
      {
        title: 'Reverse engineering & security',
        summary: 'I investigate how existing systems behave, inspect protocols and attack surfaces, and turn findings into safer designs and reversible changes.',
        items: ['Protocol analysis', 'Firmware inspection', 'Attack-path analysis', 'Security review', 'Risk assessment', 'Rollback design'],
        proof: 'ATK firmware · private security work',
        proofHref: '#project-atk-firmwaremod',
      },
      {
        title: 'Games & esports',
        summary: 'Gaming is a technical domain I know from the inside: performance, player workflows, competitive data, and tools for analysts and coaches.',
        items: ['Valorant domain', 'Esports scouting', 'Competitive data', 'Player performance', 'Game-focused UX', 'Gaming hardware'],
        proof: 'Valscout · ClutchG',
        proofHref: '#project-valscout',
      },
      {
        title: 'Delivery & technical leadership',
        summary: 'I carry work through decisions, implementation, release, and operational support, translating between business stakeholders and engineering detail.',
        items: ['Architecture decisions', 'Technical communication', 'Cloud deployment', 'Google Workspace', 'Workshop facilitation', 'Production troubleshooting'],
        proof: 'AI Lead Engineer · DMC Connect',
